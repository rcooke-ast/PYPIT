...
class Coadd2DPar(ParSet):
    ...
    def __init__(self, only_slits=None, exclude_slits=None, offsets=None, spat_toler=None, weights=None, user_obj=None,
        ...
        descr['manual'] = 'Manual extraction parameters for eac aperture to extract.  For a ' \
                          ...
                          '(det1,det2,...) is the list of detectors in the mosaic.  Multiple ' \
                          'manual extraction apertures are comma separated; e.g., ' \
                          '(1,2,3):22.4:608.1:3., (1,2,3):82.4:608.1:3.  Note spat,spec are in ' \
                          'the pixel coordinates of the pseudo-image generated by COADD2D;' \
                          'and boxcar_radius is optional and in pixels (not arcsec!).'
